...
<head>
    ...
    <title>OnlyPsychs - Therapists for ADHD</title>
...
<main id="main">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 align-self-baseline text-center">
                    <img src="assets/img/adhd-abt.jpg" class="img-fluid" style="height: 25rem" alt="">
                ...
                <div class="col-lg-6 pt-3 pt-lg-0 content">
                    ...
                    <p class="fst-italic">
                        ADHD can impact attention, impulsivity, and hyperactivity, <br>
                        making it challenging to focus, stay organized, and maintain productivity. <br>
                    </p>

                    <p class="fst-italic">
                        Our therapists specializing in ADHD provide tailored strategies, <br>
                        behavior management techniques, and practical support to help you thrive <br>
    ...
    <section id="breadcrumbs" class="breadcrumbs">
        <div class="breadcrumb-hero">
            <div class="container">
                <div class="breadcrumb-hero">
                    <h3>Based on your responses, <br> you are displaying symptoms of someone suffering with <span class="" style="color: #666699">ADHD</span> </h3> <br>
                    <h3>Here's a list of all our therapists who specializes in <span class="" style="color: #666699">ADHD</span></h3>
                    <p>Request an appointment with one of our therapists you believe is best suited to your mental health needs.</p>
    ...
    <section id="team" class="team mt-5">
        <div class="container">
            ...
            <div class="row">
                <?php
                $sql = " SELECT * FROM specializations WHERE disorder_name LIKE '%Attention Deficit Hyperactivity Disorder%' ";
