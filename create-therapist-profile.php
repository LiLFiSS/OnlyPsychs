...
while ($fetch_Therapist = mysqli_fetch_array($query)){
    ...
    /*$license = $fetch_Therapist['license'];*/
...
if (isset($_POST['update'])){
    ...
    $update3 = " INSERT INTO specializations (TID, disorder_name) VALUES ('$TUserID', '$Specialization')";
    $result2 = mysqli_query($conn, $update3);

    /*if ($Specialization2 != '' || $Specialization2 != null){
        $update4 = " INSERT INTO mental_disorders_list (TID, disorder_name) VALUES ('$TUserID', '$Specialization2')";
        $result4 = mysqli_query($conn, $update4);
    }*/

    /*$specializations = $_POST['specialization'];
    foreach ($specializations as $specialization){
        $update3 = " INSERT INTO mental_disorders_list (TID, disorder_name) VALUES ('$TUserID', '$specialization')";
        $result2 = mysqli_query($conn, $update3);
    }*/
    ...
    if ($update_therapists && $update_user){
        ...
        $UserID = $TUserID;
        $log_name = $firstName ." ". $lastName ." UserID: ". $UserID;
        $description = 'has edited their therapist profile using';
        $task = 'Create Therapist Profile';
        ...
        echo "<div class='alert alert-success mov' role='alert'> Your Profile Has Been Created Successfully! Redirecting... </div>";
        header( "refresh:4;url=profile-therapist.php" );
    } else {
        echo "<div class='alert alert-danger mov' role='alert'> Error Creating Profile! </div>";
    }
...
<head>
    ...
    <title>OnlyPsychs - Customize Therapist Profile</title>
...
<div class="main-wrapper">
    ...
    <div class="page-wrapper">
        <div class="content">
            <div class="row">
                <div class="col-sm-12">
                    <h4 class="page-title">Create Therapist Profile</h4>
                </div>
            </div>
            <form method="post" onsubmit="validateSpecialization();">
                <div class="card-box">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group form-focus">
                                            ...
                                            <input type="text" name="first-name" class="form-control floating" required value="<?php echo $firstName; ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group form-focus">
                                            <label class="focus-label">Last Name</label>
                                            <input type="text" name="last-name" class="form-control floating" required value="<?php echo $lastName; ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group form-focus">
                                            ...
                                            <div class="cal-icon">
                                                <input class="form-control floating datetimepicker" name="date-of-birth" required type="text" value="<?php echo $dob ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group form-focus">
                                ...
                                <input type="text" name="address" class="form-control floating" value="" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group form-focus">
                                <label class="focus-label">City</label>
                                <input type="text" name="city" class="form-control floating" value="" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group form-focus">
                                <label class="focus-label">Country</label>
                                <input type="text" name="country" class="form-control floating" value="" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group form-focus">
                        ...
                        <div class="col-md-6">
                            <div class="form-group form-focus">
                                ...
                                <input type="text" name="phone-number" class="form-control floating" value="<?php echo $PhoneNumber; ?>" required>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-floating">
                                <textarea name="biography" class="form-control" placeholder="" id="floatingTextarea2" style="height: 100px" required></textarea>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group form-focus">
                                ...
                                <input name="edu-name-3" type="text" class="form-control floating" value="" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group form-focus">
                                <label class="focus-label">Degree</label>
                                <input name="edu-degree-3" type="text" class="form-control floating" value="" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group form-focus">
                                ...
                                <div class="cal-icon">
                                    <input type="text" name="edu-start-year-3" class="form-control floating" value="" required>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group form-focus">
                                ...
                                <div class="cal-icon">
                                    <input type="text" name="edu-end-year-3" class="form-control floating" value="" required>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card-box edu-box-2" id="box-2">
                ...
                <div class="card-box edu-box-3" id="box-3">
                    <h3 class="card-title">Education Information</h3>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group form-focus">
                                <label class="focus-label">Institution</label>
                                <input type="text" name="edu-name-1" class="form-control floating" value="">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group form-focus">
                                <label class="focus-label">Degree</label>
                                <input type="text" name="edu-degree-1" class="form-control floating" value="">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group form-focus">
                                <label class="focus-label">Start Year</label>
                                <div class="cal-icon">
                                    <input type="text" name="edu-start-year-1" class="form-control floating" value="">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group form-focus">
                                <label class="focus-label">Complete Date</label>
                                <div class="cal-icon">
                                    <input type="text" name="edu-end-year-1" class="form-control floating" value="">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card-box">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group form-focus">
                                <label class="focus-label" for="jp">Job Position</label>
                                <input type="text" id="jp" name="exp-pos-3" class="form-control floating" value="" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group form-focus">
                                ...
                                <div class="cal-icon">
                                    <input type="text" name="exp-start-year-3" class="form-control floating" value="" required>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group form-focus">
                                ...
                                <div class="cal-icon">
                                    <input type="text" name="exp-end-year-3" class="form-control floating " value="" required>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card-box exp-box-1" id="exp-box-1">
                    <h3 class="card-title">Experience Information</h3>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group form-focus">
                                <label class="focus-label">Job Position</label>
                                <input type="text" name="exp-pos-2" class="form-control floating" value="">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group form-focus">
                                <label class="focus-label">Period From</label>
                                <div class="cal-icon">
                                    <input type="text" name="exp-start-year-2" class="form-control floating" value="">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group form-focus">
                                <label class="focus-label">Period To</label>
                                <div class="cal-icon">
                                    <input type="text" name="exp-end-year-2" class="form-control floating " value="">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card-box exp-box-2" id="exp-box-2">
                    <h3 class="card-title">Experience Information <span class="text-muted" style="font-size: 12px; font-weight: 300; margin-left: 5px;">Lowest</span></h3>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group form-focus">
                                <label class="focus-label">Job Position</label>
                                <input type="text" name="exp-pos-1" class="form-control floating" value="">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group form-focus">
                                <label class="focus-label">Period From</label>
                                <div class="cal-icon">
                                    <input type="text" name="exp-start-year-1" class="form-control floating" value="">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group form-focus">
                                <label class="focus-label">Period To</label>
                                <div class="cal-icon">
                                    <input type="text" name="exp-end-year-1" class="form-control floating " value="">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group form-focus">
                                ...
                                <input type="text" name="license-name-1" class="form-control floating" value="" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group form-focus">
                                <label class="focus-label">License Number</label>
                                <input type="text" name="license-number-1" class="form-control floating" value="" required>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card-box license-box" id="lic-box">
                    <h3 class="card-title">License Information</h3>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group form-focus">
                                <label class="focus-label">License Name</label>
                                <input type="text" name="license-name-2" class="form-control floating" value="">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group form-focus">
                                <label class="focus-label">License Number</label>
                                <input type="text" name="license-number-2" class="form-control floating" value="">
                            </div>
                        </div>
                    </div>
                    <div class="add-more" id="add-moreL-1">
                ...
                <div class="card-box" id="spc-box-1" style="height: 240px;">
                    <h3 class="card-title">Add a Specialization</h3>
                    <div class="row">
                        <div class="col-lg" >
                            <div class=" form-group form-focus specializations">
                                <div class="form-check">
                                    <input class="form-check-input" name="specialization1" type="radio" id="radioD_1" value="Depression" required>
                                    <label class="form-check-label" for="radioD_1">Depression</label>
                                </div>
                                <div class="form-check mt-1">
                                    <input class="form-check-input" name="specialization1" type="radio" id="radioAX_1" value="Anxiety" required>
                                    <label class="form-check-label" for="radioAX_1">Anxiety</label>
                                </div>
                                <div class="form-check mt-1">
                                    <input class="form-check-input" name="specialization1" type="radio" id="radioP_1" value="Post Traumatic Stress Disorder" required>
                                    <label class="form-check-label" for="radioP_1">Post Traumatic Stress Disorder</label>
                                </div>
                                <div class="form-check mt-1">
                                    <input class="form-check-input" name="specialization1" type="radio" id="radioAD_1" value="Attention Deficit Hyperactivity Disorder" required>
                                    <label class="form-check-label" for="radioAD_1">Attention Deficit Hyperactivity Disorder</label>
                                </div>
                                <div class="form-check mt-1">
                                    <input class="form-check-input" name="specialization1" type="radio" id="radioGC_1" value="General Consultation" required>
                                    <label class="form-check-label" for="radioGC_1">General Consultation</label>
                                </div>
                            </div>

                        </div>
                    </div>
                    <div class="add-more" id="add-more-spc" style="margin-top: 65px;">
                        <button type="button" onclick="showSPCBox()" id="add-spc-btn" class="btn" style="background-color: #5D3FD3; color: #fff;"><i class="fa fa-plus"></i> Add Another License</button>
                    </div>
                </div>

                <div class="card-box spc-box" id="spc-box" style="height: 240px;">
                    <h3 class="card-title">Add Another Specialization</h3>
                    <div class="row">
                        <div class="col-lg" >
                            <div class=" form-group form-focus specializations">
                                <div class="form-check">
                                    <input class="form-check-input" name="specialization2" type="radio" id="radioD_2" value="Depression" required>
                                    <label class="form-check-label" for="radioD_2">Depression</label>
                                </div>
                                <div class="form-check mt-1">
                                    <input class="form-check-input" name="specialization2" type="radio" id="radioAX_2" value="Anxiety" required>
                                    <label class="form-check-label" for="radioAX_2">Anxiety</label>
                                </div>
                                <div class="form-check mt-1">
                                    <input class="form-check-input" name="specialization2" type="radio" id="radioP_2" value="Post Traumatic Stress Disorder" required>
                                    <label class="form-check-label" for="radioP_2">Post Traumatic Stress Disorder</label>
                                </div>
                                <div class="form-check mt-1">
                                    <input class="form-check-input" name="specialization2" type="radio" id="radioAD_2" value="Attention Deficit Hyperactivity Disorder" required>
                                    <label class="form-check-label" for="radioAD_2">Attention Deficit Hyperactivity Disorder</label>
                                </div>
                                <div class="form-check mt-1">
                                    <input class="form-check-input" name="specialization2" type="radio" id="radioGC_2" value="General Consultation" required>
                                    <label class="form-check-label" for="radioGC_2">General Consultation</label>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="add-more" id="add-moreL-1" style="margin-top: 65px;">
                        <button type="button" onclick="hideSPCBox()" id="add-lic-btn-1" class="btn btn-danger" ><i class="fa fa-minus-circle"></i> </button>
                    </div>
                </div>

                <script>
                    let spcBox = document.getElementById("spc-box");
                    let addMoreSPC = document.getElementById("add-more-spc");
                    let spcBox2 = document.getElementById("spc-box-1");

                    function showSPCBox() {
                        spcBox.style.display = "revert";
                        addMoreSPC.style.display = "none";
                        spcBox2.style.height = "190px";
                    }

                    function hideSPCBox() {
                        spcBox.style.display = "none";
                        addMoreSPC.style.display = "revert";
                        spcBox2.style.height = "revert";
                    }
                    function validateSpecialization() {
                        let depressionRadio1 = document.getElementById("radioD_1");
                        let depressionRadio2 = document.getElementById("radioD_2");

                        let anxietyRadio1 = document.getElementById("radioAX_1");
                        let anxietyRadio2 = document.getElementById("radioAX_2");

                        let ptsdRadio1 = document.getElementById("radioP_1");
                        let ptsdRadio2 = document.getElementById("radioP_2");

                        let adhdRadio1 = document.getElementById("radioAD_1");
                        let adhdRadio2 = document.getElementById("radioAD_2");

                        if (depressionRadio1.checked === true && depressionRadio2.checked === true){
                            document.addEventListener('submit', (e) =>{
                                alert('Specializations Must be Different! (Depression) Please review form!');
                                e.preventDefault()
                            });
                            return false;
                        }

                        if (anxietyRadio1.checked === true && anxietyRadio2.checked === true){
                            document.addEventListener('submit', (e) =>{
                                alert('Specializations Must be Different! (Anxiety) Please review form!');
                                e.preventDefault()
                            });
                            return false;
                        }

                        if (ptsdRadio1.checked === true && ptsdRadio2.checked === true){
                            document.addEventListener('submit', (e) =>{
                                alert('Specializations Must be Different! (PTSD) Please review form!');
                                e.preventDefault()
                            });
                            return false;
                        }

                        if (adhdRadio1.checked === true && adhdRadio2.checked === true){
                            document.addEventListener('submit', (e) =>{
                                alert('Specializations Must be Different! (ADHD) Please review form!');
                                e.preventDefault()
                            });
                            return false;
                        }
