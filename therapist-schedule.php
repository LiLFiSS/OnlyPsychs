...
if (isset($_GET['delete'])){
    ...
    if ($delete_query){
        ...
        echo "<div class='alert alert-success mov' role='alert'> Appointment Competed! </div>";
...
<head>
    ...
    <title>OnlyPsychs - Schedule</title>
                ...
                <div class="col-md-12">
                    <div class="table-responsive">
                        <table class="table table-border table-striped custom-table datatable mb-0">
                            ...
                            <tbody>
                            <?php
                            $sql = "SELECT * FROM appointments WHERE TherapistID = '$TUserID' AND Status = 'Accepted'";
