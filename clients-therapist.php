...
<head>
    ...
    <title>OnlyPsychs - Clients</title>
        ...
        <div class="content">
            <div class="row">
                <div class="col-sm-4 col-3">
                    <h4 class="page-title">Client Cases - Active </h4>
                </div>
                ...
                <div class="col-md-12">
                    <div class="table-responsive">
                        <table class="table table-border table-striped custom-table datatable mb-0">
                            ...
                            <tbody>
                            <?php
                            $sql = "SELECT * FROM cases WHERE therapist_id = '$TUserID' AND Status = 'Active'";
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                <div class="dropdown dropdown-action">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        <a class="dropdown-item" href="patient-records.php?id=<?php echo $patientID ?>"><i class="fa fa-envelope m-r-5"></i> Records</a>
