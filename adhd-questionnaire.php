...
if (isset($_POST['submit'])){
    ...
    if ($question_1 == 'Yes' && $question_2 == 'Yes' && $question_3 == 'Yes'){
        header( "refresh:4;url=adhd-therapists.php");
...
<head>
    ...
    <title>OnlyPsychs - Get Started - ADHD Questions</title>
    ...
    <div class="container-fluid smaller mov2">
        ...
        <div class="desc mb-5">
            <p class="text-justify text-center">
                We will now ask you a series of screening questions from the ASRS,
                a recognized assessment for ADHD (Attention-Deficit/Hyperactivity Disorder) in adults.
                Your responses will help us gain insights into specific symptoms associated with ADHD.
            ...
            <div class="h-100 d-flex align-items-center justify-content-center">
                <form method="post" class="" onsubmit=" return submitValidation()">
                    ...
                    <div class="question-1-depression" id="question-1-d" style="padding: 3rem 4rem; box-shadow: 5px 5px 12px -1px rgba(0,0,0,0.75); border-radius: 3px; background-color: #f2f2f2;">
                        <h4 class="text-center mt-2">Do you often have trouble wrapping up the final details of a project once the challenging parts have been done?</h4>
                    ...
                    <div class="question-2-depression" id="question-2-d" style="padding: 3rem 4rem; box-shadow: 5px 5px 12px -1px rgba(0,0,0,0.75); border-radius: 3px; background-color: #f2f2f2;">
                        <h4 class="text-center mt-2">Do you frequently have problems remembering appointments or obligations?</h4>
                        <div class="d-flex flex-column align-items-center justify-content-center">
                            <div role="group" aria-label="Basic radio toggle button group">
                    ...
                    <div class="question-3-depression" id="question-3-d" style="padding: 3rem 4rem; box-shadow: 5px 5px 12px -1px rgba(0,0,0,0.75); border-radius: 3px; background-color: #f2f2f2;">
                        <h4 class="text-center mt-2">Do you often avoid or delay getting started when you have a task that requires a lot of thought?</h4>
                        <div class="d-flex flex-column align-items-center justify-content-center">
                            <div role="group" aria-label="Basic radio toggle button group">
