...
if (isset($_POST['submit'])){
    ...
    if ($question_1 == 'Yes' && $question_2 == 'Yes' && $question_3 == 'Yes'){
        header( "refresh:4;url=depression-therapists.php");
...
<head>
    ...
    <title>OnlyPsychs - Get Started - Depression Questions</title>
    ...
    <div class="container-fluid smaller mov2">
        ...
        <div class="desc mb-5">
            <p class="text-justify text-center">
                To better understand your mental well-being,
                we will now ask you a series of screening questions from the PHQ-9,
                a widely recognized depression assessment tool.
                Your responses will help us gain insights into your
                emotional state and guide us in providing the most appropriate support. <br>
            ...
            <div class="h-100 d-flex align-items-center justify-content-center">
                <form method="post" class="" onsubmit=" return submitValidation()">
                    ...
                    <div class="question-1-depression" id="question-1-d" style="padding: 3rem 4rem; box-shadow: 5px 5px 12px -1px rgba(0,0,0,0.75); border-radius: 3px; background-color: #f2f2f2;">
                        <h4 class="text-center mt-2">Have you felt down, depressed, or hopeless?</h4>
