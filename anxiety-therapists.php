...
<head>
    ...
    <title>OnlyPsychs - Therapists for Anxiety</title>
...
<main id="main">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 align-self-baseline text-center">
                    <img src="assets/img/anxiety-img.jpg" class="img-fluid" style="height: 25rem" alt="">
                ...
                <div class="col-lg-6 pt-3 pt-lg-0 content">
                    <h3>Anxiety</h3>
                    <p class="fst-italic">
                        Anxiety can manifest as excessive worry, fear, and a constant sense of unease.
                        It can interfere with daily activities, relationships, and overall quality of life.
                    </p>

                    <p class="fst-italic">
                        Our anxiety specialists are dedicated to helping you manage and alleviate anxiety symptoms,
                        providing you with practical tools, coping strategies,
                        and techniques to foster a greater sense of calm, control, and confidence.
                    </p>
    ...
    <section id="breadcrumbs" class="breadcrumbs">
        <div class="breadcrumb-hero">
            <div class="container">
                <div class="breadcrumb-hero">
                    <h3>Based on your responses, <br> you are displaying symptoms of someone suffering with <span class="" style="color: #666699">Generalized Anxiety Disorder</span> </h3> <br>
                    <h3>Here's a list of all our therapists who specializes in <span class="" style="color: #666699">Anxiety</span></h3>
                    <p>Request an appointment with one of our therapists you believe is best suited to your mental health needs.</p>
    ...
    <section id="team" class="team mt-5">
        <div class="container">
            ...
            <div class="row">
                ...
                <?php
                $sql = " SELECT * FROM specializations WHERE disorder_name LIKE '%Anxiety%' ";
