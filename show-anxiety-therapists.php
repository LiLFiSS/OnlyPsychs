...
<main id="main">
    ...
    <section id="breadcrumbs" class="breadcrumbs">
        <div class="breadcrumb-hero">
            <div class="container">
                <div class="breadcrumb-hero">
                    <h2>Here's a list of all our therapists who specializes in <span class="" style="color: #666699">Anxiety</span></h2>
                    <!--<p>Request an appointment with one of our therapists you believe is best suited to your mental health needs.</p>-->
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
                    <div class="member" data-aos="fade-up">
                        ...
                        <div class="member-info">
                            ...
                            <p>Animi est delectus alias quam repellendus nihil nobis dolor.
                            ...
                            <p class="">
                                <a href="" class="btn spc-btn">Schedule Appointment</a>
                            </p>
