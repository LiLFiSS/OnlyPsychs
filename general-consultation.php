...
<head>
    ...
    <title>OnlyPsychs - General Consultation</title>
...
<main id="main">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 align-self-baseline text-center">
                    <img src="assets/img/5248863.jpg" class="img-fluid" alt="">
                ...
                <div class="col-lg-6 pt-3 pt-lg-0 content">
                    ...
                    <p class="fst-italic">
                        ...
                        encompassing our emotional, psychological, and social well-being.
                        It affects how we think, feel, and act, and influences how we handle stress,
                        relate to others, and make choices in life. Good mental health is crucial for
                        maintaining a balanced and fulfilling life.
                    </p>

                    <p class="fst-italic">
                        Taking care of our mental health involves various factors, including self-care practices,
                        healthy relationships, and seeking support when needed. It's important to recognize that
                        mental health is a spectrum, and everyone experiences ups and downs in their mental well-being.
                    </p>

                    <p class="fst-italic">
                        Promoting mental health involves fostering resilience, developing coping strategies,
                        and nurturing positive mental habits. It also includes seeking professional help when
                        faced with challenges that impact our mental well-being. Mental health professionals,
                        such as therapists and counselors, are trained to provide support, guidance, and evidence-based
                        interventions to help individuals navigate through mental health concerns.
                    </p>

                    <p class="fst-italic">
                        By prioritizing mental health, we can enhance our overall quality of life, improve relationships,
                        and better manage stress and adversity. Remember, seeking help is a sign of strength, and taking
                        care of your mental well-being is a valuable investment in yourself.
                    </p>
    ...
    <section id="breadcrumbs" class="breadcrumbs">
        <div class="breadcrumb-hero">
            <div class="container">
                <div class="breadcrumb-hero">
                    <h3>Based on your responses, we recommend scheduling an appointment with one of our <span class="" style="color: #666699">General Consultation</span> therapists for a more conclusive evaluation and personalized guidance.</h3>
                    <p>Our therapists are experienced in assessing a wide range of mental health concerns and can provide valuable insights
                        based on your specific needs. To book an appointment or learn more about our services, please visit our appointment
                        scheduling page or contact our team directly. We are here to support you on your journey towards better mental well-being.
                    </p>
                </div>
            </div>
        </div>
    ...
    <section id="team" class="team mt-5">
        <div class="container">
            ...
            <div class="row">
                <?php
                $sql = " SELECT * FROM specializations WHERE disorder_name LIKE '%General Consultation%' ";
                ...
                while ($rows = mysqli_fetch_array($query)){
                    ...
                    /*if ($first == "Attention Deficit Hyperactivity Disorder"){
                        $specialization1 = $first ." (ADHD)";
                        $specialization2 = $second;
                    } else if ($second == 'Attention Deficit Hyperactivity Disorder'){
                        $specialization1 = $second ." (ADHD)";
                        $specialization2 = $first;
                    }*/

                    /*if ($first == "Post Traumatic Stress Disorder"){
                        $specialization2 = $first ." (PTSD)";
                        $specialization1 = $second;
                    } else if ($second == "Post Traumatic Stress Disorder"){
                        $specialization2 = $second ." (PTSD)";
                        ...
                        <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
                            <div class="member" data-aos="fade-up">
                                <div class="member-img">
                                    ...
                                    <div class="social">
                                        <a href="user-view-therapists.php?id=<?php echo $TID ?>"><i class="bi bi-twitter"></i></a>
                                        <a href="user-view-therapists.php?id=<?php echo $TID ?>"><i class="bi bi-facebook"></i></a>
                                        <a href="user-view-therapists.php?id=<?php echo $TID ?>"><i class="bi bi-instagram"></i></a>
                                        <a href="user-view-therapists.php?id=<?php echo $TID ?>"><i class="bi bi-linkedin"></i></a>
                                    </div>
                                </div>
