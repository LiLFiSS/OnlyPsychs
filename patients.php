...
<head>
    ...
    <title>OnlyPsychs - Patients</title>
        ...
        <div class="content">
            <div class="row">
                <div class="col-sm-4 col-3">
                    <h4 class="page-title">Client Cases</h4>
                </div>
                ...
                <div class="col-md-12">
                    <div class="table-responsive">
                        <table class="table table-border table-striped custom-table datatable mb-0">
                            ...
                            $select_cases = mysqli_query($conn, $sql) or die('query failed');
                            if (mysqli_num_rows($select_cases) > 0){
                                while ($fetch_ID = mysqli_fetch_assoc($select_cases)){
                                    $patientID = $fetch_ID['patient_id'];
                                    $tID = $fetch_ID['therapist_id'];

                                    $select_users = "SELECT * FROM users WHERE UserID = '$patientID'";
                                    $user_query = mysqli_query($conn, $select_users);
                                    while ($fetch_users = mysqli_fetch_array($user_query)){
                                    ?>
                                    <tr>
                                        <td><?php echo $fetch_users['UserID'] ?></td>
                                        <td><img width="28" height="28" src="assets/uploaded_img/<?php echo $fetch_users['profile_picture'];?>" class="rounded-circle m-r-5" alt="pp"> <?php echo $fetch_users['first_name']; ?></td>
                                        <td><?php echo $fetch_users['last_name']; ?></td>
                                        <!--<td>1545 Dorsey Ln NE, Leland, NC, 28451</td>-->
                                        <td><?php echo $fetch_users['phone_num']; ?></td>
                                        <td><?php echo $fetch_users['email']; ?></td>
                                        <td>TR:00<?php echo $tID ?></td>
                                        <td class="text-right">
                                            <div class="dropdown dropdown-action">
                                                <a href="#" class="action-icon dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="fa fa-ellipsis-v"></i></a>
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a class="dropdown-item" href="patient-records.php"><i class="fa fa-envelope m-r-5"></i> Records</a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
