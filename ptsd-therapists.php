...
<head>
    ...
    <title>OnlyPsychs - Therapists for PTSD</title>
...
<main id="main">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 align-self-baseline text-center">
                    <img src="assets/img/ptsd-img.jpg" class="img-fluid" style="height: 25rem" alt="">
                ...
                <div class="col-lg-6 pt-3 pt-lg-0 content">
                    ...
                    <p class="fst-italic">
                        PTSD often occurs after experiencing or witnessing a traumatic event.
                        It can lead to distressing flashbacks, nightmares, hyper-vigilance, and emotional numbness.
                    </p>

                    <p class="fst-italic">
                        Our therapists who specialize in PTSD are trained in trauma-focused therapies,
                        offering a safe and supportive space for healing, processing trauma,
                        and restoring a sense of safety, resilience, and empowerment.
                    </p>
    ...
    <section id="breadcrumbs" class="breadcrumbs">
        <div class="breadcrumb-hero">
            <div class="container">
                <div class="breadcrumb-hero">
                    <h3>Based on your responses, <br> you are displaying symptoms of someone suffering from <span class="" style="color: #666699">PTSD</span> </h3> <br>
                    <h3>Here's a list of all our therapists who specializes in <span class="" style="color: #666699">PTSD</span></h3>
                    <p>Request an appointment with one of our therapists you believe is best suited to your mental health needs.</p>
    ...
    <section id="team" class="team mt-5">
        <div class="container">
            ...
            <div class="row">
                ...
                <?php
                $sql = " SELECT * FROM specializations WHERE disorder_name LIKE '%Post Traumatic Stress Disorder%' ";
