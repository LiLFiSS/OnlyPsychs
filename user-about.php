        ...
        <nav id="navbar" class="navbar">
            <ul>
                ...
                <li class="dropdown"><a href="#"><span>About</span> <i class="bi bi-chevron-down"></i></a>
                    <ul >
                        <li class="active"><a href="user-about.php">About</a></li>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 pt-3 pt-lg-0 content">
                    <h3>Welcome to OnlyPsychs</h3>
                    <p class="fst-italic">
                        We are dedicated to providing exceptional mental health care and support.
                        Our team of highly qualified therapists is committed to helping individuals like you navigate life's challenges,
                        achieve personal growth, and improve overall well-being.
                    </p>

                    <p class="fst-italic">
                        At OnlyPsychs, we believe in the power of therapy and its ability to transform lives.
                        With diverse backgrounds and expertise, our compassionate therapists specialize in a range of areas,
                        including depression, anxiety, ADHD, and PTSD.
                        We understand that seeking therapy can be a significant step,
                        and we are here to create a safe and nurturing environment for your healing journey.
                    </p>

                    <p>
                        At OnlyPsychs, we are dedicated to making mental health care accessible to all.
                        We offer flexible appointment options and strive to create a welcoming and comfortable experience for every individual
                        who walks through our virtual doors.
                    </p>
                    <!--<ul>
        ...
        <div class="container">
            ...
            <div class="row content">
                <div class="col-md-5" data-aos="fade-right">
                    <img src="assets/assets/img/3885261.jpg" class="img-fluid" alt="">
                </div>
            ...
            <div class="row content">
                <div class="col-md-5 order-1 order-md-2" data-aos="fade-left">
                    <img src="assets/assets/img/dude.jpg" class="img-fluid" alt="">
                </div>
            ...
            <div class="row content">
                <div class="col-md-5" data-aos="fade-right">
                    <img src="assets/assets/img/7762424.jpg" class="img-fluid" alt="">
                </div>
            ...
            <div class="row content">
                <div class="col-md-5 order-1 order-md-2" data-aos="fade-left">
                    <img src="assets/assets/img/7770487.jpg" class="img-fluid" alt="">
                </div>
                <div class="col-md-7 pt-5 order-2 order-md-1" data-aos="fade-right">
        ...
        <div class="container" data-aos="fade-up">
            ...
            <div class="clients-slider swiper">
                <div class="swiper-wrapper align-items-center">
                    <div class="swiper-slide"><img src="assets/assets/img/clients/client-1.png" class="img-fluid" alt=""></div>
                    <div class="swiper-slide"><img src="assets/assets/img/clients/client-2.png" class="img-fluid" alt=""></div>
                    <div class="swiper-slide"><img src="assets/assets/img/clients/client-3.png" class="img-fluid" alt=""></div>
                    <div class="swiper-slide"><img src="assets/assets/img/clients/client-4.png" class="img-fluid" alt=""></div>
                    <div class="swiper-slide"><img src="assets/assets/img/clients/client-5.png" class="img-fluid" alt=""></div>
                    <div class="swiper-slide"><img src="assets/assets/img/clients/client-6.png" class="img-fluid" alt=""></div>
                    <div class="swiper-slide"><img src="assets/assets/img/clients/client-7.png" class="img-fluid" alt=""></div>
                    <div class="swiper-slide"><img src="assets/assets/img/clients/client-8.png" class="img-fluid" alt=""></div>
                </div>
                <div class="swiper-pagination"></div>
            </div>
